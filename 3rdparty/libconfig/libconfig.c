...
/* locale overriding is pretty pointless (Ceos-Emulator doesn't make use of the area that uses locale functionality), but I'm actually removing it because it floods the buildbot with warnings  */
