 ...
 *  Ceos-Emulator Display por Zell
 *--------------------------------------*/
static void display_title(void) {
	...
	ShowMessage(""CL_PASS"     "CL_BT_WHITE"      Ceos-Emulator - Emulador de Ragnarok                                                  "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD"  _____                       _____                _       _                                    "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD" /  __ \                     |  ___|              | |     | |                                   "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD" | /  \/ ___  ___  ___ ______| |__ _ __ ___  _   _| | __ _| |_ ___  _ __                        "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD" | |    / _ \/ _ \/ __|______|  __| '_ ` _ \| | | | |/ _` | __/ _ \| '__|                       "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD" | \__/\  __/ (_) \__ \      | |__| | | | | | |_| | | (_| | || (_) | |                          "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BOLD"  \____/\___|\___/|___/      \____/_| |_| |_|\__,_|_|\__,_|\__\___/|_|                          "CL_PASS""CL_CLL""CL_NORMAL"\n");
	ShowMessage(""CL_PASS"     "CL_BLUE"              http://ceos-emulator.com.br                                                       "CL_PASS""CL_CLL""CL_NORMAL"\n");
...
#ifndef _WIN32
    if (geteuid() == 0) {
		ShowWarning ("You are running Ceos-Emulator with root privileges, it is not necessary.\n");
    }
#endif
}
